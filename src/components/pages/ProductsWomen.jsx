...
import productsListWomenData from '../products/productsListWomen.json'
    ...
    <>
      ...
      <div className='row'>
          <div className="col-5 col-md-6 d-flex align-items-center justify-content-start product">
              <h2 className="product_title">Zapatillas Mujer</h2>
          </div>
          ...
          <div className='col-12'>
            <div className='row'>
              ...
              <div id="zoom" class="col-10">
                <div id="contenidomujer" className="row">
                    {productsListWomenData.map(producto => 
